...
if (isset($_POST['pay'])) {
    ...
    echo "<tr><th align='left'>Bus</th><td>{$booking['bus_name']}</td></tr>";
    echo "<tr><th align='left'>Passenger</th><td>{$booking['name']}</td></tr>";
    echo "<tr><th align='left'>Seats</th><td>{$booking['seats']}</td></tr>";
    echo "<tr><th align='left'>Travel Date</th><td>{$booking['travel_date']}</td></tr>";
    echo "<tr><th align='left'>Amount Paid</th><td>₹{$booking['amount']}</td></tr>";
    echo "</table><br>";

    echo "<h3>💳 Payment Details</h3>";
    echo "<table border='1' cellpadding='8' cellspacing='0' width='100%'>";
    echo "<tr><th align='left'>Card Holder</th><td>{$card_holder}</td></tr>";
    echo "<tr><th align='left'>Card Number</th><td>**** **** **** " . substr($card_number, -4) . "</td></tr>";
    echo "<tr><th align='left'>Expiry</th><td>{$expiry}</td></tr>";
    echo "</table>";
    echo "</div><br>";
